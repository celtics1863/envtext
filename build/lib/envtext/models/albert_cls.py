...
class AlbertCLSModel(AlbertPreTrainedModel):
    def __init__(self, config):
        super(AlbertCLSModel, self).__init__(config)
...
class AlbertCLS(CLSBase,BertBase): 
    '''
    Albert分类模型
   ...
   Kwargs:
    ...
    def initialize_bert(self,path = None,config = None,**kwargs):
        ...
        self.model = AlbertCLSModel.from_pretrained(self.model_path,config = self.config)
